<script lang="ts">
    ...
    // Si pasa un arreglo de errores (como suele dar Superforms), tomamos el primero
...
<div class="flex flex-col gap-1.5 w-full">
    ...
    <input
        ...
        class="w-full rounded-lg border px-4 py-2.5 text-sm transition-all duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-offset-0 disabled:cursor-not-allowed disabled:opacity-50 bg-white dark:bg-transparent dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-500
      {errorMessage
